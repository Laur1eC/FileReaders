...
//        System.out.println(catWord);
        ...
        if(dogWord.equalTo(dogWord)) {
            System.out.println(dogWord + " is the same as " + dogWord);
        } else {
            System.out.println(dogWord + " is not the same as " + dogWord);
        }
        if(dogWord.equalTo(catWord)) {
            System.out.println(dogWord + " is the same as " + catWord);
        } else {
            System.out.println(dogWord + " is not the same as " + catWord);
        }
